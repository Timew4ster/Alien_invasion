...
class Scoreboard:
    """Una clase para mostar información de puntuación."""

    def __init__(self, ai_game):
        """Inicializa atributos puntuación."""
        ...
        # Configuraciones de fuente para información de puntuación.
        self.text_color = (30, 30, 30)
        self.font = pygame.font.SysFont(None, 48)

        # Prepara las imágenes de puntuación inicial.
        self.prep_score()
    ...
    def show_score(self):
        """Dibuja las puntuaciones, el nivel y las naves en la pantalla."""
